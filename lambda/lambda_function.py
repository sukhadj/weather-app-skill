...
key = "" # Your weather app key goes here
...
def get_alexa_location(context):
    URL =  "https://api.amazonalexa.com//v1/devices/{device_id}/settings/address".format(device_id=context.system.device.device_id)
    print(URL)
    TOKEN =  context.system.user.permissions.consent_token
...
class YourCityWeatherHandler(AbstractRequestHandler):
    """Handler for Weather Intent."""
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return ask_utils.is_intent_name("YourCityWeather")(handler_input)

    def handle(self, handler_input):
        print("This is somethig - ",dir(handler_input.request_envelope.context.system))
        print("This is somethig else - ",dir(handler_input.request_envelope.context.system.device))
...
sb.add_request_handler(YourCityWeatherHandler())
